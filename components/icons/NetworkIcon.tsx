...
const NetworkIcon: React.FC<IconProps> = ({ size = 24, color }) => {
  const { colors } = useTheme();
  const fill = color ?? colors.statusSuccess;
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <G clipPath="url(#network_clip)" transform="translate(2 2) scale(0.8333)">
        <Path
