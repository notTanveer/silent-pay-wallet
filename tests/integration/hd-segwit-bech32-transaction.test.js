...
const decodeAddress = script => bitcoin.address.fromOutputScript(script, bitcoin.networks.bitcoin);
...
describe('HDSegwitBech32Transaction', () => {
  ...
  it('can do RBF - cancel tx', async function () {
    ...
    const addr = decodeAddress(createdTx.outs[0].script);
