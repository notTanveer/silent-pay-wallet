...
const ScanIcon: React.FC<ScanIconProps> = ({ color = 'white', width = 40, height = 36 }) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 31 30" fill="none">
      ...
      <Rect x="6.5" y="6" width="6" height="6" rx="1" stroke={color} strokeWidth="4" mask="url(#path-14-inside-1_5568_10466)" />
      <Rect x="6.5" y="18" width="6" height="6" rx="1" stroke={color} strokeWidth="4" mask="url(#path-15-inside-2_5568_10466)" />
      <Rect x="18.5" y="6" width="6" height="6" rx="1" stroke={color} strokeWidth="4" mask="url(#path-16-inside-3_5568_10466)" />
    </Svg>
  );
};
