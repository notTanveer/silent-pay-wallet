...
export const ShroudDefaultTheme = {
  ...
  colors: {
    ...
    buttonBlueBackgroundColor: palette.blue300,
    buttonGrayBackgroundColor: palette.gray150,
    incomingBackgroundColor: '#d2f8d6',
    outgoingBackgroundColor: palette.pink200,
    ...
    successCheck: '#00A63E',
    msSuccessBG: palette.teal500,
    msSuccessCheck: palette.white,
    newBlue: '#007AFF',
