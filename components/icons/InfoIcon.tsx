...
const InfoIcon: React.FC<IconProps> = ({ color, size = 20 }) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 20 20" fill="none">
      ...
      />
      <Path d="M9.99634 13.3286V9.99646" stroke={stroke} strokeWidth={1.66607} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M9.99634 6.66431H10.0047" stroke={stroke} strokeWidth={1.66607} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
};
